"""
    repeat(city, num_times, method, max_depth)
...
"""
function repeat(city, num_times, method, max_depth)
    city_problem = read_city_problem(city)
    best_solution, best_distance = method(city_problem; max_depth=max_depth)
